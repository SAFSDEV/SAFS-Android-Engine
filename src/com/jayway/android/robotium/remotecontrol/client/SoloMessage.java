...
public class SoloMessage extends Message {
	...
	public static final String RESULT_INFO_VIEW_NULL			= " The View is null. ";
	
	public static final String RESULT_INFO_GENERATE_UID_NULL	= " The generated UID is null. ";
	
	public static final String RESULT_INFO_VIEW_TAG_INVALID		= " The View's Tag is not valid. ";

	/**
	 * Return true if the key exists in the properties.<br>
	 * 
	 */
	public static boolean exist(Properties props, String key){		
	...
	/**
	 * Convert a com.jayway.android.robotium.remotecontrol.By to a com.robotium.solo.By.<br>
	 * 
	 */
	public static By getSoloBy(com.jayway.android.robotium.remotecontrol.By by){
		...
		if(tempObj instanceof By){
			...
			//In case that the method by.toSoloBy() can't return the correct com.robotium.solo.By object
